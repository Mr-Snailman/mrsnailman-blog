...
const getContent = (classes) =>
  <React.Fragment>
    <Typography paragraph><img className={ classes.blogImage } src={ boiling } alt='Boiling'  /> After a brewer has finished Mashing his grains, the wort produced is ready to enter the Boiling phase. Although the mashing temperature of 140-160&deg; F (60-70&deg; C) will remove most bacteria and unwanted molecular substances, we must sterilize the wort so that the yeast can enter a bacteria free environment. Additionally, during the boil, we are able to infuse the beautiful hop character that some styles are known for.</Typography>
